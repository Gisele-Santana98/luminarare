...
export default function ChatbotPage() {
  const [mensagens, setMensagens] = useState<Mensagem[]>([
    {
      ...
      role: "assistant",
      content:
        "Olá! Sou o assistente educativo do LuminaRare. Estou aqui para responder suas dúvidas sobre doenças raras de forma simples e acolhedora. Como posso te ajudar hoje?",
    },
  ])
  ...
  async function enviar(texto?: string) {
    ...
    const novasMensagens: Mensagem[] = [...mensagens, msgUsuario]
